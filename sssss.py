...
def save_professor():
    ...
    if not name :
        return
    # for i, d in enumerate(professors):
...
print("Found schedule:", z)
# Debug print
fit_arr=[fit for gen,fit in scat]
gen_arr=[gen for gen,fit in scat]
plt.scatter(gen_arr ,fit_arr,c=gen_arr,cmap='viridis')
